pag_table_new["widget_set_device_flo"] = {
	onload: function()
	{
		...
		storing = false;
		//
		item_room(".widget_set_device_flo", this.xml_any);
		//
		...
		global_item_init(".widget_set_device_flo", "name", "input", null, null, null, nameDev, this.xml_any.children("name").attr("maxlength"));
	...
	par_save: function()
	{
		ena_save = true;
		//
		save_item_name(".widget_set_device_flo", this);
		//save_room
