pag_table_new["widget_set_device_pir"] = {
	onload: function()
	{
		...
		storing = false;
		//
		item_room(".widget_set_device_pir", this.xml_any);
		//
		...
		global_item_init(".widget_set_device_pir", "name", "input", null, null, null, nameDev, this.xml_any.children("name").attr("maxlength"));
	...
	par_save: function()
	{
		ena_save = true;
		//
		save_item_name(".widget_set_device_pir", this);
		//
