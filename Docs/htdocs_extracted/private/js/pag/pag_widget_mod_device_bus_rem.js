pag_table_new["widget_mod_device_bus_rem"] = {
	onload: function()
	{
		...
		//
		//
		item_dev_areas("#container_bus_remote", this);
		//
		global_item_init("#container_bus_remote", "name", "input", "name", this);
		//
		tslotf("#container_bus_remote", this.xml_any);
		//
		item_delete("#container_bus_remote", this);
	},
	...
	//
	name: "widget_mod_device_bus_rem",
	...
	par_save: function()
	{
		ena_save = true;
		//
		save_item_name("#container_bus_remote", this);
		//
