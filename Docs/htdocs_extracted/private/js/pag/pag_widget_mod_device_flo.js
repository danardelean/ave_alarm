pag_table_new["widget_mod_device_flo"] = {
	onload: function()
	{
		...
		//
		//name
		global_item_init("#container_flo", "name", "input", "name", this);
		//room
		item_room("#container_flo", this.xml_any);
		//anti removal protection
		item_protection("#container_flo", this.xml_any, this);
		//led allarme
		item_led("#container_flo", this.xml_any, this);
		//
		picker("#container_flo");
		//tvcc
		item_tvcc("#container_flo", this);
		//
		item_tvcc_delay_initial("#container_flo", this);
		//
		item_fw_ver("#container_flo", this.xml_any);
		//
		item_delete("#container_flo", this);
	},
	...
	par_save: function()
	{
		ena_save = true;
		//
		save_item_name("#container_flo", this);
		//save_room
		if (DIY) this.xml_any.find("room").text(id_room_selected);
		// protect
		save_item_protection("#container_flo", this.xml_any, this);
		// led
		save_item_led("#container_flo", this.xml_any, this);
		//
		save_item_tvcc("#container_flo", this);
		//"save_item_tvcc_delay_initial" sempre dopo "save_item_tvcc"
		save_item_tvcc_delay_initial("#container_flo", this);
	},
