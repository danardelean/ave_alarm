pag_table_new["widget_set_device_senuni"] = {
	onload: function()
	{
		...
		storing = false;
		//
		item_room(".widget_set_device_senuni", this.xml_any);
		//
		...
		global_item_init(".widget_set_device_senuni", "name", "input", null, null, null, nameDev, this.xml_any.children("name").attr("maxlength"));
	...
	par_save: function()
	{
		ena_save = true;
		//
		save_item_name(".widget_set_device_senuni", this);
		//
		this.xml_any.find("room").text(id_room_selected);
		//
		if (this.son1 != null)
		{
			this.son1.children("name").text($(".widget_set_device_senuni .name").val() + "a");
			this.son1.find("room").text(id_room_selected);
		}
		if (this.son2 != null)
		{
			this.son2.children("name").text($(".widget_set_device_senuni .name").val() + "b");
