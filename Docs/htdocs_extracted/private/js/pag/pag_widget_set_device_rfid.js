pag_table_new["widget_set_device_rfid"] = {
	onload: function()
	{
		...
		var widget_device_type_str = xml_file_configuration
			.find("Categories")
			.find("Category[id='" + this.xml_any.find("category").text() + "']")
		...
		global_item_init(".widget_set_device_rfid", "name", "input", null, null, null, nameDev, this.xml_any.children("name").attr("maxlength"));
	...
	par_save: function()
	{
		ena_save = true;
		//
		save_item_name(".widget_set_device_rfid", this);
		//
