pag_table_new["widget_mod_device_bus_relay"] = {
	onload: function()
	{
		...
		//
		//name
		global_item_init("#container_bus_relay", "name", "input", "name", this);
		//room
		item_room("#container_bus_relay", this.xml_any);
		//
		global_load_areas_switcher("#area_container_mod", this.xml_any, this);
		//
		picker("#container_bus_relay");
//		//
		item_mode_alarm("#container_bus_relay", this);
//		//
		item_timing("#container_bus_relay", this);
//		//
		item_abilitation("#container_bus_relay", this);
//		//
		item_trigger_relay("#container_bus_relay", this);
//		//
		item_real_relay("#container_bus_relay", this);
		//
		item_fw_ver("#container_bus_relay", this.xml_any);
		//
		item_delete("#container_bus_relay", this);
	},
	...
	onrecv_indication: function(indi)
	{
		if (indi.attr("type") == "MENU")
		{
			if (indi.children("act").text() == "DELETE")
			{
				...
				{
					tyu(indi.children("res").text() + ": " + indi.children("desc").text());
				}
			}
		}
	},
	...
	//
	name: "widget_mod_device_bus_relay",
	...
	par_save: function()
	{
		ena_save = true;
		//
		save_item_name("#container_bus_relay", this);
		//
		...
		//
		save_item_area("#container_bus_relay", this);
	},
					...
					(
						...
						(
							(
								...
								|| subcategory == WS_DEV_ALARM_BUS_CONC_RF_STR
							)
							&& 
							(
								xml_any_tbl[i].children("ord").text() == "0"
