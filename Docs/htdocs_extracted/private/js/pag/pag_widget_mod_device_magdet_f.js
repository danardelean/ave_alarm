pag_table_new["widget_mod_device_magdet_f"] = {
	onload: function()
	{
		...
		/*SON 1*/
		//
		global_switcher_binder("#container_magdet", "ena_son1", null, this.son1.children("phy_mode").text() == "0" ? "0" : "1");
		//
		/*SON 2*/
		//
		global_switcher_binder("#container_magdet", "ena_son2", null, this.son2.children("phy_mode").text() == "0" ? "0" : "1");
	},
	...
	//
	name: "widget_mod_device_magdet_f",
	xml_any: xml_any_tbl[any_ind],
	title: xml_any_tbl[any_ind].children("name").text(),
	son1: xml_any_tbl[any_ind].find("has_children").text() == "1" ? xml_any_tbl[any_ind-1+2] : null,
	son2: xml_any_tbl[any_ind].find("has_children").text() == "1" ? xml_any_tbl[any_ind-1+3] : null,
	...
	par_save: function()
	{
		...
		/********** son1 *********/
		//ena dal padre	
		if ($("#container_magdet .ena_son1").attr("data-checked") != "0" && this.son1.children("phy_mode").text() == "0")
		{
			this.son1.children("pulse_n").text("6");
			this.son1.children("phy_mode").text("4");
		}
		else if ($("#container_magdet .ena_son1").attr("data-checked") == "0" && this.son1.children("phy_mode").text() != "0")
		{
		...
		/********** son2 *********/	
		//ena dal padre
		if ($("#container_magdet .ena_son2").attr("data-checked") != "0" && this.son2.children("phy_mode").text() == "0")
		{
			this.son2.children("pulse_n").text("6");
			this.son2.children("phy_mode").text("4");
		}
		else if ($("#container_magdet .ena_son2").attr("data-checked") == "0" && this.son2.children("phy_mode").text() != "0")
		{
